...
<head>
    ...
    <title>Edit Berita — Ariva Consulta</title>
    ...
    <style>
        * { font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        #previewGambar { max-width: 100%; max-height: 250px; border-radius: 10px; border: 1px solid #e2e8f0; object-fit: cover; }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <div class="topbar">
        <div>
            <h5 class="fw-bold mb-0 text-dark">Edit Berita / Kegiatan</h5>
            <small class="text-secondary">Perbarui informasi berita atau ganti foto berita</small>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="judul" class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul', $berita->judul) }}" placeholder="Tuliskan judul berita...">
                            @error('judul')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Tanggal Publish</label>
                            <input type="date" name="tanggal_publish" class="form-control @error('tanggal_publish') is-invalid @enderror" value="{{ old('tanggal_publish', $berita->tanggal_publish) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="konten" rows="8" class="form-control @error('konten') is-invalid @enderror" placeholder="Tuliskan cerita, caption, atau informasi lengkap di sini...">{{ old('konten', $berita->konten) }}</textarea>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-4">
                            <label class="form-label">Ganti Foto Berita (Maks 10MB)</label>
                            ...
                            <small class="text-muted d-block mt-2">Biarkan kosong jika tidak ingin mengganti foto. Dukungan format: JPG, PNG, GIF, WebP. Maks 10MB.</small>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="p-2 border rounded text-center bg-light" style="min-height: 150px; display: flex; align-items: center; justify-content: center;">
                                <img id="previewGambar" src="{{ asset($berita->gambar) }}">
                            </div>
                        </div>
                    </div>
                </div>

...
<div class="login-card">
    ...
    <div class="login-body">
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('biodata')); ?>" class="text-secondary small text-decoration-none">
...
<?php /**PATH C:\laragon\www\dass-app\resources\views/admin/login.blade.php ENDPATH**/ ?>
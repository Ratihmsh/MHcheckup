...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Tes Kesehatan Mental DASS — Ariva Consulta'); ?></title>
   ...
   <nav class="navbar navbar-dark navbar-ariva py-2">
    <div class="container">
        ...
        <a class="navbar-brand" href="<?php echo e(route('landing')); ?>">
            <img src="<?php echo e($globalSettings && $globalSettings->logo ? asset($globalSettings->logo) : asset('images/logo.jpg')); ?>" alt="<?php echo e($globalSettings->nama_biro ?? 'Ariva Consulta'); ?>"
                style="height:38px; max-width:160px; object-fit:contain;">
        </a>
        <span class="text-white-50 small d-none d-sm-inline"><?php echo e($globalSettings->nama_biro ?? 'Biro Psikologi Sidoarjo'); ?></span>
    </div>
</nav>
    <!-- KONTEN -->
    <main class="py-4">
    ...
    <footer class="footer-ariva text-center">
        <div class="container">
            <p class="mb-0">© <?php echo e(date('Y')); ?> <?php echo e($globalSettings->nama_biro ?? 'Biro Psikologi Ariva Consulta'); ?>. Semua hak dilindungi.</p>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\dass-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>
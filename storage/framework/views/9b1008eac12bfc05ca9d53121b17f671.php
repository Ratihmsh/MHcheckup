...
<nav class="navbar-ariva" id="navbar">
    <div class="container d-flex align-items-center justify-content-between">
        <a href="/" class="navbar-brand">
            <img src="<?php echo e($settings && $settings->logo ? asset($settings->logo) : asset('images/logo.jpg')); ?>" alt="<?php echo e($settings->nama_biro ?? 'Ariva Consulta'); ?>"
                style="height:50px; max-width:250px; object-fit:contain;">
        </a>
        <a href="<?php echo e(route('biodata')); ?>" class="btn-mulai-nav">
    ...
    <div class="container">
        <div class="row align-items-center g-5">
            <div class="col-lg-6">
                ...
                <h1><?php echo e($settings->headline ?? 'Kenali Kondisi Kesehatan Mentalmu'); ?></h1>
                <p>
                    <?php if($settings && $settings->deskripsi): ?>
                        <?php echo e($settings->deskripsi); ?>
                ...
                <a href="<?php echo e(route('biodata')); ?>" class="btn-mulai">
    ...
    <div class="container">
        <div class="text-center mb-5 reveal">
            ...
            <p class="section-desc" style="max-width:560px; margin:0 auto;">
                Ikuti perkembangan kegiatan sosial, seminar, dan tips menarik dari <?php echo e($settings->nama_biro ?? 'Biro Psikologi Ariva Consulta'); ?>.
            </p>
        </div>
        <div class="row g-4 reveal mobile-slider-row">
            ...
            <div class="col-md-6 col-lg-4 mobile-slider-col">
                <div class="card h-100 border-0 shadow-sm" style="border-radius: 16px; overflow: hidden; transition: all 0.3s; cursor: pointer; box-shadow: 0 4px 18px rgba(0,0,0,0.05);" 
                     ...
                     data-gambar="<?php echo e(asset($item->gambar)); ?>"
                     data-tanggal="<?php echo e(\Carbon\Carbon::parse($item->tanggal_publish)->translatedFormat('d F Y')); ?>"
                     data-konten="<?php echo e($item->konten); ?>"
                     onclick="openNewsModal(this)">
                    <div style="height: 200px; overflow: hidden; position: relative;">
                        <img src="<?php echo e(asset($item->gambar)); ?>" alt="<?php echo e($item->judul); ?>" class="w-100 h-100" style="object-fit: cover; transition: transform 0.5s;" onmouseover="this.style.transform='scale(1.05)'" onmouseout="this.style.transform='scale(1)'">
                        <span class="position-absolute top-0 start-0 m-3 badge bg-primary" style="border-radius: 8px; font-weight: 600; font-size: 0.78rem;">
                            <?php echo e(\Carbon\Carbon::parse($item->tanggal_publish)->translatedFormat('d M Y')); ?>

                        </span>
                    </div>
                    <div class="card-body p-4" style="background:#fff;">
                        <h5 class="card-title fw-bold text-dark mb-2" style="font-size: 1.1rem; line-height: 1.4;"><?php echo e($item->judul); ?></h5>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-5 reveal">
                ...
                <a href="<?php echo e(route('biodata')); ?>" class="btn-mulai-nav" style="font-size:1rem; padding:14px 28px;">
...
<section class="section-cta">
    <div class="container position-relative">
        <div class="reveal">
            ...
            <a href="<?php echo e(route('biodata')); ?>" class="btn-mulai" style="margin: 0 auto;">
                <i class="bi bi-play-circle-fill"></i>
                Mulai Tes Sekarang
            </a>
    ...
    <div class="container">
        <div class="row g-4">
            <div class="col-lg-5">
                ...
                <p class="footer-info">
                    <?php echo e($settings->nama_biro ?? 'Biro Psikologi Ariva Consulta'); ?><br>
            ...
            <div class="col-lg-4">
                ...
                <div class="kontak-item">
                    <i class="bi bi-geo-alt-fill"></i>
                    <span><?php echo e($settings->alamat ?? 'Jl. H. Syukur V RT 25 RW XI No.5 Sedati – Sidoarjo'); ?></span>
                </div>
                <div class="kontak-item">
                    <i class="bi bi-telephone-fill"></i>
                    <a href="tel:<?php echo e($settings->no_telp ?? '085857176646'); ?>" style="color:#64748b; text-decoration:none;"><?php echo e($settings->no_telp ?? '085857176646'); ?></a>
                </div>
                <div class="kontak-item">
                    <i class="bi bi-envelope-fill"></i>
                    <a href="mailto:<?php echo e($settings->email ?? 'arivaconsulta@gmail.com'); ?>" style="color:#64748b; text-decoration:none;"><?php echo e($settings->email ?? 'arivaconsulta@gmail.com'); ?></a>
                </div>
                <div class="kontak-item">
                    <i class="bi bi-whatsapp" style="color:#25d366;"></i>
                    <?php
                    ...
                    ?>
                    <a href="https://wa.me/<?php echo e($waPhone); ?>" target="_blank" style="color:#64748b; text-decoration:none;">Chat via WhatsApp</a>
                </div>
            </div>
            <div class="col-lg-3">
                <div class="footer-brand mb-3">Tautan</div>
                <div class="footer-info">
                    <a href="<?php echo e(route('biodata')); ?>" style="color:#64748b; text-decoration:none; display:block; margin-bottom:8px;">
                        <i class="bi bi-arrow-right me-1"></i>Mulai Tes DASS
                    </a>
                    <a href="<?php echo e(route('admin.login')); ?>" style="color:#64748b; text-decoration:none; display:block;">
        ...
        <div class="footer-bottom">
            © <?php echo e(date('Y')); ?> PT. Ariva Konsultama Indonesia — <?php echo e($settings->nama_biro ?? 'Biro Psikologi Ariva Consulta Sidoarjo'); ?>.
        </div>
    </div>
</footer>
...
<script>
    ...
    function resetChatbot() {
        ...
        fetch('<?php echo e(route("chatbot.reset")); ?>', {
            method: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'Content-Type': 'application/json',
...
<?php /**PATH C:\laragon\www\dass-app\resources\views/user/landing.blade.php ENDPATH**/ ?>
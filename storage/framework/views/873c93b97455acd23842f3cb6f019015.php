<?php $__env->startSection('title', 'Tes DASS — Ariva Consulta'); ?>
...
<div class="container" style="max-width: 700px;">
    ...
    <form action="<?php echo e(route('tes.simpan')); ?>" method="POST" id="formTes">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="peserta_id" value="<?php echo e($peserta->id); ?>">
        ...
        <div class="card">
            <div class="card-body p-4">
                ...
                <?php for($h = 0; $h < $totalHalaman; $h++): ?>
                <div class="halaman-soal <?php echo e($h === 0 ? 'active' : ''); ?>" id="halaman-<?php echo e($h); ?>">

                    <?php for($s = 0; $s < $soalPerHalaman; $s++): ?>
                        <?php
                        ...
                        <div class="soal-item">
                            <div class="soal-nomor">Pernyataan <?php echo e($no); ?></div>
                            <div class="soal-teks"><?php echo e($pertanyaan); ?></div>
                            <div class="pilihan-grid">
                                <?php $__currentLoopData = [0 => 'Tidak Pernah', 1 => 'Kadang-kadang', 2 => 'Sering', 3 => 'Hampir Selalu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nilai => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="pilihan-label" id="label-<?php echo e($no); ?>-<?php echo e($nilai); ?>">
                                    <input type="radio" name="soal_<?php echo e($no); ?>" value="<?php echo e($nilai); ?>"
                                        onchange="pilihanDipilih(<?php echo e($no); ?>, this)">
                                   <span class="pilihan-teks" style="font-size:0.88rem;"><?php echo e($label); ?></span>
                                </label>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <div class="soal-warning" id="warning-<?php echo e($no); ?>">
    ...
    <p class="text-center text-secondary small mt-3">
        <i class="bi bi-person me-1"></i><?php echo e($peserta->nama); ?>
...
<script>
    ...
    const TOTAL_SOAL = <?php echo e(count($soal)); ?>;
    ...
    ?>
    const halamanSoal = <?php echo json_encode($halamanSoal, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\dass-app\resources\views/user/tes.blade.php ENDPATH**/ ?>
...
<div class="sidebar">
    ...
    <div class="sidebar-menu">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-item active">
...
<div class="main-content">
    ...
    <div class="topbar">
        <div>
            ...
            <small class="text-secondary">Selamat datang, <?php echo e(auth()->user()->name); ?></small>
        </div>
        <div class="d-flex align-items-center gap-3">
            ...
            <a href="<?php echo e(route('admin.peserta.list')); ?>" class="btn-lihat-peserta">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-angka"><?php echo e($totalPeserta); ?></div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-angka"><?php echo e($tesHariIni); ?></div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-angka"><?php echo e($perluPerhatian); ?></div>
        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-angka"><?php echo e($laporanAi); ?></div>
            ...
            <div class="chart-card">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div>
                        ...
                        <div class="chart-subtitle">Mengukur persentase kecocokan klasifikasi algoritma Support Vector Machine (Python) terhadap rumus manual DASS-42 di database (Total Data Uji: <?php echo e($totalSvmData); ?> Peserta)</div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="p-3 border rounded-3" style="background:#fcfdff;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="fw-bold text-primary" style="font-size: 1.1rem;"><?php echo e($akurasiDepresi); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px; border-radius: 6px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($akurasiDepresi); ?>%; border-radius: 6px;" aria-valuenow="<?php echo e($akurasiDepresi); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 small text-secondary">
                                <span>Kecocokan: <?php echo e($cocokDepresi); ?>/<?php echo e($totalSvmData); ?> data</span>
                    ...
                    <div class="col-md-4">
                        <div class="p-3 border rounded-3" style="background:#fdfdff;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="fw-bold" style="font-size: 1.1rem; color: #9333ea;"><?php echo e($akurasiKecemasan); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px; border-radius: 6px;">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($akurasiKecemasan); ?>%; background-color: #9333ea; border-radius: 6px;" aria-valuenow="<?php echo e($akurasiKecemasan); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 small text-secondary">
                                <span>Kecocokan: <?php echo e($cocokKecemasan); ?>/<?php echo e($totalSvmData); ?> data</span>
                                <span>F1-Score Model: 98.4%</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="p-3 border rounded-3" style="background:#fdfcff;">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                ...
                                <span class="fw-bold" style="font-size: 1.1rem; color: #ea580c;"><?php echo e($akurasiStres); ?>%</span>
                            </div>
                            <div class="progress" style="height: 10px; border-radius: 6px;">
                                <div class="progress-bar" role="progressbar" style="width: <?php echo e($akurasiStres); ?>%; background-color: #ea580c; border-radius: 6px;" aria-valuenow="<?php echo e($akurasiStres); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            <div class="d-flex justify-content-between mt-2 small text-secondary">
                                <span>Kecocokan: <?php echo e($cocokStres); ?>/<?php echo e($totalSvmData); ?> data</span>
                                <span>F1-Score Model: 98.4%</span>
                            </div>
                        </div>
                    </div>
...
new Chart(document.getElementById('chartTren'), {
    type: 'line',
    data: {
        labels: <?php echo json_encode($trenLabel, 15, 512) ?>,
        datasets: [{
            label: 'Peserta',
            data: <?php echo json_encode($tren, 15, 512) ?>,
            borderColor: '#1a56db',
...
new Chart(document.getElementById('chartDonut'), {
    ...
    data: {
        ...
        datasets: [{
            data: [
                <?php echo json_encode($risikoTinggi, 15, 512) ?>,
                <?php echo json_encode($risikoSedang, 15, 512) ?>,
                <?php echo json_encode($risikoAman, 15, 512) ?>
            ],
            backgroundColor: [
                '#dc2626', // Merah (Tinggi)
...
new Chart(document.getElementById('chartBar'), {
    ...
    data: {
        ...
        datasets: [
            { label: 'Depresi',   data: <?php echo json_encode($katDepresi, 15, 512) ?>,   backgroundColor: 'rgba(26,86,219,0.7)',  borderRadius: 6 },
            { label: 'Kecemasan', data: <?php echo json_encode($katKecemasan, 15, 512) ?>, backgroundColor: 'rgba(147,51,234,0.7)', borderRadius: 6 },
            { label: 'Stres',     data: <?php echo json_encode($katStres, 15, 512) ?>,     backgroundColor: 'rgba(234,88,12,0.7)',  borderRadius: 6 }
        ]
    },
    options: {
        responsive: true,
...
<?php /**PATH C:\laragon\www\dass-app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>